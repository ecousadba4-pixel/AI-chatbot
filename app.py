...
def cached_gpt_response(prompt, context, token, expire=259200):  # 3 дня кэша
        ...
        "messages": [
            {
                ...
                "text": (
                    "Ты чат-бот отеля. "
                    "Отвечай кратко — не более трёх предложений. "
                    "Используй только контекст из базы. "
...
def chat():
    ...
    context = get_context_from_qdrant(user_input, top_n=3)
